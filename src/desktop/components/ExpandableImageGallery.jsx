...
const ExpandableImageGallery = () => {
  ...
  return (
    <div className="flex items-center justify-center mt-6 bg-[#FAF9F8]">
      <div className="flex w-full max-w-3xl overflow-hidden rounded-xl shadow-lg gap-3 h-[70vh] mr-20">
        <div
        ...
        >
          ...
          >
            <div className="pb-8 ml-24">
              <h2 className="w-10 font-medium text-3xl font-stolzl">
                Anatomy Course
              </h2>
            </div>
            <div className="mr-24 mb-10 font-stolzl ">
              <h2 className="text-3xl">166</h2>
              <h2 className="mt-2">Topics</h2>
            </div>
          </div>
        </div>
        ...
        >
          <div className="h-full overflow-hidden rounded-lg bg-[#FAF9F8]">
            ...
            />
            {expandedId !== 2 && (
              <div className="absolute bottom-0 left-0 h-24 w-24 bg-[#060029] flex items-center justify-center mb-10">
